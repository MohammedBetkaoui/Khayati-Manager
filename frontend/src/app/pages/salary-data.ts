...
export const mockPayroll: PayrollRecord[] = [
  {
    id: "pay_1",
    workerName: { ar: "أحمد بن علي", fr: "Ahmed Ben Ali" },
    role: "tailor",
    salaryType: "piece",
    period: "جوان 2026",
    workDays: 22,
    ...
    paymentDate: null,
    status: "unpaid",
    notes: { ar: "تأخر يوم 15 جوان", fr: "Retard le 15 Juin" }
  },
  {
    id: "pay_2",
    workerName: { ar: "سميرة بن يوسف", fr: "Samira Ben Youcef" },
    role: "supervisor",
    salaryType: "monthly",
    period: "جوان 2026",
    workDays: 26,
    ...
    pieceRate: 0,
    baseSalary: 45000,
    bonuses: 5000, // Prime de rendement
    deductions: 0,
    advances: 0,
    netSalary: 50000,
    paidAmount: 50000,
    ...
    status: "paid",
    notes: { ar: "مكافأة جودة الإنتاج", fr: "Prime de qualité" }
  },
  {
    id: "pay_3",
    workerName: { ar: "يوسف حمدي", fr: "Youcef Hamdi" },
    role: "ironer",
    salaryType: "daily",
    period: "الأسبوع 4 - جوان",
    workDays: 5,
    absentDays: 1,
    lateHours: 0,
    piecesCount: 0,
    pieceRate: 0,
    baseSalary: 6000, // 5 jours * 1200
    bonuses: 0,
    deductions: 1200, // 1 jour d'absence
    advances: 2000,
    netSalary: 2800,
    paidAmount: 1400,
    paymentDate: "2026-06-25",
    status: "partial",
    notes: { ar: "غياب بدون عذر مسبق", fr: "Absence non justifiée" }
  },
  {
    id: "pay_4",
    workerName: { ar: "نادية شريف", fr: "Nadia Cherif" },
    role: "tailor",
    salaryType: "mixed",
    period: "جوان 2026",
    workDays: 24,
    ...
    paymentDate: null,
    status: "unpaid",
    notes: { ar: "سلفة 10000 دج بداية الشهر", fr: "Avance de 10000 DA" }
  }
];
